...
// ══ 보유분 평가수익률 ═══════════════════════════════════════════════════
t_head('pf_eval_rate — 평가손익 ÷ 총매입 (수익률과 다른 자)');
t_eq('매입 100만 손실 −10만 → −10%', -0.10, pf_eval_rate(-100000, 1000000), 1e-9);
t_eq('관일산업 실측 −3,407,903 / 18,297,663', -0.18625, pf_eval_rate(-3407903, 18297663), 1e-5);
t_eq('이익이면 양수', 0.25, pf_eval_rate(250000, 1000000), 1e-9);
t_eq('보유 없음(매입 0)은 0% 가 아니라 null', null, pf_eval_rate(0, 0));
t_eq('평가손익 null 이면 null', null, pf_eval_rate(null, 1000000));
